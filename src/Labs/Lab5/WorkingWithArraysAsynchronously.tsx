            ...
            <ListGroup>
                {todos.map((todo) => (
                    <ListGroup.Item key={todo.id}>
                        ...
                        {/*  X add another remove button to try this new deleteTodo client function */}
                        <TiDelete onClick={() => deleteTodo(todo)} className="text-danger float-end me-2 fs-3" id="wd-delete-todo" />

                        {/* click a new pencil icon by setting the todo's editing property to true */}
                        ...
                        {/* Add an onChange attribute to the completed checkbox so that it updates the corresponding property of the todo object */}
