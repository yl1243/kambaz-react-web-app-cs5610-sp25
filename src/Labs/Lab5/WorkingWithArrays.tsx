...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            {/* Filter Array： Add a hyperlink to the React component to test retrieving all completed todos. */}
            ...
            <a id="wd-retrieve-completed-todos" className="btn btn-primary " href={`${API}/${todo.id}/delete`}>
            ...
            <h4>Update Todo Description and Completed</h4>
            <FormControl className="w-50 mb-2"
                placeholder="Description"
                value={todo.description}
                onChange={(e) => setTodo({ ...todo, description: e.target.value })}
            />
            <a className="btn btn-success mb-2 ms-2"
